...
catalog = babel.messages.catalog.Catalog(domain=None, header_comment=u'# Translations template for PROJECT.\n# Copyright (C) YEAR ORGANIZATION\n# This file is distributed under the same license as the PROJECT project.\n# FIRST AUTHOR <EMAIL@ADDRESS>, YEAR.\n#', project="stellarium-website", version="1.0", copyright_holder="Stellarium's team", msgid_bugs_address="stellarium@googlegroups.com", creation_date=None, revision_date=None, last_translator=None, language_team=None, charset=None, fuzzy=True)
for fn in all_files:
  with open(fn, 'r' ) as f:
    content = f.read()
