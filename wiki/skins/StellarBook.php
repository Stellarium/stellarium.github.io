 ...
 * StellarBook
 *
 * Adapted MonoBook skin for Stellarium
 ...
 * @subpackage Skins
 */
class SkinStellarBook extends SkinTemplate {
	/** Using stellarbook. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'stellarbook';
		$this->stylename = 'stellarbook';
		$this->template  = 'StellarBookTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class StellarBookTemplate extends QuickTemplate {
	/**
	 * Template filter callback for StellarBook skin.
...
<?php		}
		...
		wfRunHooks( 'StellarBookTemplateToolboxEnd', array( &$this ) );
?>
			</ul>
		</div>
	</div>
